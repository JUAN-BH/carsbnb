const q1 = {
  ...
  a: `Comparing rental car deals is important as it helps find the best
...
const q2 = {
  ...
  a: `You can find car rental deals by researching online and 
  comparing prices from different rental companies. Websites such 
  as Expedia, Kayak, and Travelocity allow you to compare prices and view 
  available rental options. It is also recommended to sign up for 
  email newsletters and follow rental car companies on social media to be informed of 
  any special deals or promotions.`,
};
const q3 = {
  id: 3,
  q: '3. How do I find such low rental car prices?',
  a: `Book in advance: Booking your rental car ahead of time can often 
  ...
  rental price. Renting from an off-airport location can sometimes result in lower prices.`,
};
